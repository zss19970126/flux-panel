...
面板端(稳定版)：
```bash
curl -L https://raw.githubusercontent.com/zss19970126/flux-panel/main/panel_install.sh -o panel_install.sh && chmod +x panel_install.sh && ./panel_install.sh
```
节点端(稳定版)：
```bash
curl -L https://raw.githubusercontent.com/zss19970126/flux-panel/main/install.sh -o install.sh && chmod +x install.sh && ./install.sh

```

面板端(开发版)：
```bash
curl -L https://raw.githubusercontent.com/zss19970126/flux-panel/beta/panel_install.sh -o panel_install.sh && chmod +x panel_install.sh && ./panel_install.sh
```
节点端(开发版)：
```bash
curl -L https://raw.githubusercontent.com/zss19970126/flux-panel/beta/install.sh -o install.sh && chmod +x install.sh && ./install.sh
